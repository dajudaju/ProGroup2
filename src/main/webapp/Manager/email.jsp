    ...
    <div class="row">
        <div class="email-edge col-lg-2">
            ...
            <dl class="email-folder">
                <dt>文件夹</dt>
                <dd>
                    <a href="javascript:;" data-url="email-list.jsp"><i class="iconfont">&#xe69b;</i>收件箱<span class="layui-badge f-r">12</span></a>
                </dd>
                <dd>
                    <a href="javascript:;" data-url="email-list.jsp"><i class="iconfont">&#xe69f;</i>发信<span class="layui-badge layui-bg-cyan f-r">6</span></a>
                </dd>
                <dd>
                    <a href="javascript:;" data-url="email-list.jsp"><i class="iconfont">&#xe6a2;</i>草稿<span class="layui-badge layui-bg-blue f-r">2</span></a>
                </dd>
                <dd>
                    <a href="javascript:;" data-url="email-list.jsp"><i class="layui-icon">&#xe640;</i><span class="layui-badge layui-bg-green f-r">4</span>垃圾箱</a>
                </dd>
            </dl>
