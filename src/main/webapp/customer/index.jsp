        ...
        <section class="products">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-lg-4">
                        <article>
                            ...
                            <div class="figure-grid">
                                <div class="image">
                                    <a href="${pageContext.request.contextPath}/customerServlet?cmd=showwareinpage&wid=${u.w_id}">
                                ...
                                <div class="text">
                                    ...
                                    <a href="${pageContext.request.contextPath }/customerServlet?cmd=findwarebyid&wid=${u.w_id}">没有数据？别担心，点击加载试试</a><br>
                                    <!-- <sub>$ 159,-</sub> -->
                                    <sup>$ ${wareprice } </sup> 
                                </div>
                            </div>
                    ...
                    <c:forEach items="${listware }" var="u" begin="0" step="1" varStatus="vs">											
						<div class="col-6 col-lg-4">
                        <article>
                            <div class="info">
                                <span class="add-">
                                    <a href="${pageContext.request.contextPath}/customerServlet?cmd=addtoshoucang&uid=${cid}&wid=${u.w_id}" data-title="添加到收藏" data-title-added="加入收藏">
                                        <i class="icon icon-heart"></i>                    
                                    </a>
                                </span>
                                <span>
                    ...
                    <div class="product-info-wrapper">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="info-box">
                                    <strong>库存</strong>
                                    <span><i class="fa fa-check-square-o"></i> ${warerepertory }有货</span>
                                </div>
                            </div>
