...
<head>
    ...
    <!--Title-->
    <title>Products grid - Divano - Furniture HTML Template</title>
    ...
    <div class="wrapper">
        ...
        <section class="products pt-0">
            ...
            <header>
                <div class="container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.jsp">小飞猪首页</a></li>
                        <li class="breadcrumb-item"><a href="#">沙发专区</a></li>
                        <!-- <li class="breadcrumb-item active" aria-current="page">Data</li> -->
                    </ol>
                    <h2 class="title">沙发专区</h2>
                    <div class="text">
                    ...
                    <div class="col-12">
                        ...
                        <div class="sort-bar clearfix">
                            ...
                            <div class="sort-results pull-left">
                                ...
                                <span>每页最多展示12件商品 ，共<strong></strong> 条数据</span>
                ...
                <div class="banner-image" style="background-image:url(assets/images/gallery-1.jpg)">
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4">
                                <a href="#" class="btn btn-clean">现在订阅</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="popup-table">
                    ...
                    <div class="popup-cell">
                        <div class="popup-buttons">
                            <a href="product.jsp"><span class="icon icon-eye"></span> <span class="hidden-xs">View more</span></a>
