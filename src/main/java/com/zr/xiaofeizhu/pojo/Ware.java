...
public class Ware implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (t_id != other.t_id)
			return false;
		if (w_brand == null) {
			if (other.w_brand != null)
				return false;
		} else if (!w_brand.equals(other.w_brand))
			return false;
		if (w_describe == null) {
			if (other.w_describe != null)
				return false;
		} else if (!w_describe.equals(other.w_describe))
			return false;
		if (w_id != other.w_id)
			return false;
		if (w_material == null) {
			if (other.w_material != null)
				return false;
		} else if (!w_material.equals(other.w_material))
			return false;
		if (w_name == null) {
			...
			return false;
		if (Double.doubleToLongBits(w_price) != Double.doubleToLongBits(other.w_price))
			return false;
		if (w_repertory != other.w_repertory)
			return false;
		if (w_sale != other.w_sale)
			return false;
		if (w_state != other.w_state)
			return false;
		if (w_url == null) {
			if (other.w_url != null)
				return false;
		} else if (!w_url.equals(other.w_url))
			return false;
		return true;
	}
	@Override
